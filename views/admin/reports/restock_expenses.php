...
// Query untuk mendapatkan data pengeluaran restock
$query = "SELECT p.nama_produk, r.tanggal_restock, r.jumlah_ditambahkan, r.harga_per_unit, r.total_biaya, s.nama AS nama_supplier
          FROM restock r 
...
<head>
    ...
    <title>Laporan Pengeluaran Restock</title>
    ...
    <div class="container-fluid mt-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white shadow-sm p-2">
                ...
                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-coins"></i> Laporan Pengeluaran Restock</li>
            </ol>
        </nav>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $row): ?>
                            <tr>
                                ...
                                <td><?= date('d-m-Y', strtotime($row['tanggal_restock'])); ?></td>
